export function renderContent(route) {
    const routes = {
        'home': renderHome(),
    ...
    return `
        ...
        <section class="max-w-4xl mx-auto px-6 mb-40 text-center reveal">
            <div class="liquid-glass p-16 rounded-[3rem] border border-cyan-500/20">
                ...
                <button onclick="navigateTo('contact')" class="primary-cta px-12 py-6 rounded-2xl font-bold text-lg">
                    Strukturiertes Erstgespräch anfragen
                </button>
            </div>
        </section>
    `;
...
function renderNavCard(title, subtitle, icon, link, hash = '') {
    return `<div onclick="navigateTo('${link}'); if('${hash}') setTimeout(() => document.querySelector('${hash}').scrollIntoView({behavior:'smooth'}), 100)" class="p-8 liquid-glass rounded-2xl border border-white/10 hover:bg-cyan-500/5 hover:border-cyan-500/30 transition-all cursor-pointer group relative overflow-hidden h-full flex flex-col justify-between">
        <div>
...
function renderProblemCard(num, title, text) {
    return `<div class="p-8 liquid-glass rounded-3xl border border-white/5 reveal h-full">
...
function renderResultBlock(title, text) {
    return `<div class="p-8 bg-white/[0.02] border border-white/5 rounded-3xl reveal">
        <h3 class="text-white font-bold text-xl mb-3">${title}</h3>
        <p class="text-gray-400 text-sm leading-relaxed">${text}</p>
    </div>`;
}
...
function renderPhase(num, title, text) {
    return `<div class="p-6 bg-white/[0.02] border border-white/5 rounded-2xl reveal group hover:bg-white/[0.04] transition-all">
...
function renderPrinciple(text) {
    return `<div class="p-4 liquid-glass rounded-xl border border-white/5 reveal flex items-center justify-center text-center">
...
function renderSolutions() {
    return `<section class="max-w-7xl mx-auto px-6 mb-32">
        ...
        <div class="max-w-4xl mx-auto mt-40 text-center reveal">
            ...
            <button onclick="navigateTo('contact')" class="primary-cta px-12 py-6 rounded-2xl font-bold">Strukturiertes Erstgespräch anfragen</button>
        </div>
    </section>`;
}

function renderSolutionCard(title, text) {
    return `<div class="liquid-glass p-10 rounded-[2rem] reveal border border-white/5">
    ...
    return `<section class="max-w-7xl mx-auto px-6 mb-32">
        ...
        <div class="max-w-3xl mx-auto text-center reveal">
            ...
            <div class="liquid-glass p-16 rounded-[3rem] border border-cyan-500/20">
                ...
                <button onclick="navigateTo('contact')" class="primary-cta px-10 py-5 rounded-xl font-bold uppercase tracking-widest">Anfrage stellen</button>
            </div>
        </div>
    </section>`;
}
...
function renderPricing() {
    return `<section class="max-w-7xl mx-auto px-6 mb-32">
        ...
        <div class="max-w-4xl mx-auto text-center reveal">
            ...
            <button onclick="navigateTo('contact')" class="primary-cta px-12 py-6 rounded-2xl font-bold text-lg">Strukturiertes Erstgespräch anfragen</button>
        </div>
    </section>`;
}

function renderPriceCard(title, price, desc, scope, featured = false) {
    return `<div class="liquid-glass p-10 rounded-3xl flex flex-col reveal ${featured ? 'border-cyan-500/40 ring-1 ring-cyan-500/20 shadow-[0_0_50px_rgba(6,182,212,0.1)]' : 'border-white/5'}">
        ...
        <button onclick="navigateTo('contact')" class="${featured ? 'primary-cta' : 'bg-white/5 border border-white/10 hover:bg-white/10'} w-full py-4 rounded-xl font-bold transition-all">Anfragen</button>
    </div>`;
}
    ...
    return `<section class="max-w-7xl mx-auto px-6 mb-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32 reveal">
            ...
            <div>
                ...
                <p class="text-gray-400 leading-relaxed">STS steigt über ein sichtbare Problem ein, klärt den Zustand dahinter und setzt die nötige technische Ordnung um. Das Ziel ist nie theoretische Eleganz, sondern ein Zustand, der im Alltag und bei Veränderung tatsächlich besser funktioniert.</p>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto text-center reveal">
            ...
            <button onclick="navigateTo('contact')" class="primary-cta px-10 py-5 rounded-xl font-bold uppercase tracking-widest">Kontakt aufnehmen</button>
        </div>
    </section>`;
}
    ...
    return `<section class="max-w-7xl mx-auto px-6 mb-32">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div class="reveal">
                ...
                <button class="primary-cta px-10 py-5 rounded-xl font-bold uppercase tracking-widest mb-16">Strukturiertes Erstgespräch anfragen</button>
...
function renderFaq() {
    ...
    return `<section class="max-w-4xl mx-auto px-6 mb-32">
...
function renderImprint() {
    return `<section class="max-w-3xl mx-auto px-6 py-20 text-gray-400 reveal">
        ...
        <div class="mt-12 space-y-8 text-sm">
            <div><h4 class="text-white font-bold mb-2">Haftung für Inhalte</h4><p>Die Inhalte dieser Website wurden mit größtmöglicher Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und Aktualität der Inhalte wird jedoch keine Gewähr übernommen.</p></div>
            <div><h4 class="text-white font-bold mb-2">Urheberrecht</h4><p>Die auf dieser Website veröffentlichten Inhalte und Werke unterliegen dem Urheberrecht. Jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedarf der vorherigen schriftlichen Zustimmung.</p></div>
        </div>
    </section>`;
}
